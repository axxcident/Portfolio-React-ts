...
const Services: React.FC = () => {
  ...
  //   padding: "1rem",
  //   display: "flex",
  //   justifyContent: "center",       style={styles}
  //   alignItems: "center",
  //   height: "90vh",
  // };      Ide: Tala om hur jag kan bygga User interfaces med flera språk.
  //          Tala om att jag kan bygga funktioner m flera språk. Erfarenhet med att koda js, ts, java & Python (inkl Python).
  //          Tala om att jag kan Designa/photoshoppa
