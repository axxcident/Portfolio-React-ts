...
const ServiceSection: React.FC<ServiceProps> = ({ bgTheme }) => {
  return (
    <>
      {bgTheme ? (
        <ServiceWrap bgTheme={true} className="services-page">
          ...
          <div className="service1">
            <div className="service-item1">
              ...
              <p>
                ...
                framework Vue.js. Proficient and capable to code with
            ...
            <div className="service-item1">
              ...
              <p>
                Built several user interfaces within the javascript library
                React. With regular javascript and with typescript. This
                portfolio is built with React and typescript!{" "}
              </p>
            </div>
            <div className="service-item1">
              ...
              <p>
                ...
                first portfolio page was built with these three languages.
                "link".{" "}
              </p>
            </div>
          </div>
          ...
          <div className="service3">
            <div className="service3-item">
              ...
              <p className="service3-text">
                Designed frontend applications in several small case projects
                with Figma. Proficient with Photoshop and Photopea. Used to
                offer image editing on Fiverr (link){" "}
              </p>
            </div>
          </div>
        </ServiceWrap>
      ) : (
        <ServiceWrap bgTheme={false} className="services-page">
          <div className="service-header">
            <h2>Services</h2>
          </div>
          <div className="service-header-sub">
